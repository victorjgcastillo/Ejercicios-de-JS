...
const mostrarEnConsola = (list) => {
    console.log(list);
    const LOLStrimer = streamers.filter((streamer) => streamer.name.toLowerCase().includes(input$$.value.toLowerCase()))
    console.log(LOLStrimer);
}

input$$.addEventListener('input', mostrarEnConsola);